...
In imaginile urmatoare se poate observa cum algoritmul PCA si algoritmul KPCA afecteaza setul de date two-moon, rezultatul obtin prin folosirea KPCA este mult mai bun. 
...
Fetele rezultate din acest algoritm reprezinta toti vectorii proprii care contribuie la spatiul fetelor intr-un mod semnificativ, si sunt sortati dupa valoarea proprie: 

** IMAGINE EIGENFACES AICI ** 

Pentru a putea proiecta o imagine noua in spatiul fetelor, tot ce trebuie sa facem este sa inmultim vectorul imaginii cu matricea vectorilor proprii
